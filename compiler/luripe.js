  ...
  addEventListener(){}, querySelector: () => null, querySelectorAll: () => [], body: { appendChild(){} },
      ...
      function compile(source) {
        ...
        function compileBlock(body) {
          __blockDepth++;
          // PER-BLOCK HYBRID: statements at the top level AND inside first-level
          // do/if/for blocks each get their own VM-or-island decision. A single
          // unsupported statement becomes an encrypted island; the rest stay VM.
          const atTop = __blockDepth <= 2;
